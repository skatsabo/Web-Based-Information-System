...
<?php
	...
	$stmt = $conn->prepare("SELECT * FROM proponent WHERE username = '$username'"); 
    $stmt->execute();
	...
	<div id = "content" >
		<p style = "text-align:center">Welcome <?php echo "$name" . " " . "$surname" . "!" ?> </p>		
				...
				<div style = "text-align:center">
					If you want to import questions press the link:<a href="Form_Proponent.php" style = "color:DodgerBlue">Import questions</a>
				</div>
				<br><br>	    
		<div id="footer">
		</div>
